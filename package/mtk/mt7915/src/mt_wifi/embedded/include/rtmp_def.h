...
#if defined(MT7615) || defined(MT7622) || defined(P18) || defined(MT7663) || defined(AXE) || defined(MT7626) || defined(MT7915)
...
#if defined(MT7615) || defined(MT7622) || defined(P18) || defined(MT7663) || defined(AXE) || defined(MT7626) || defined(MT7915)
#define MAX_REORDERING_MPDU_NUM			 (512 * 16)
#else
...
#define MT2_MLME_S1G_CATE_TWT_TEARDOWN  (MAX_IEEE_STD_CATE + 6)
#define MT2_MLME_WNM_EVT_REPORT         (MAX_IEEE_STD_CATE + 7)
#define MT2_MLME_S1G_CATE_TWT_SETUP		(MAX_IEEE_STD_CATE + 8)
#define MT2_ACT_INVALID                 (MAX_IEEE_STD_CATE + 9)

#define MAX_ACT_MSG                     (MAX_IEEE_STD_CATE + 10)
